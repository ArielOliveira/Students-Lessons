...
public class StaticShader extends ShaderProgram {
    private static final String VERTEX_SOURCE_PATH = "src/main/java/com/arielado/shaders/vertexShader.glsl";
    private static final String FRAGMENT_SOURCE_PATH = "src/main/java/com/arielado/shaders/fragmentShader.glsl";
