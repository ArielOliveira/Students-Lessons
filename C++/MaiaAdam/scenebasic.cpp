...
void SceneBasic::update( float t )
{
    ...
    mat4 rotationX = glm::rotate(mat4(1), t, vec3(1, 0, 0));
    mat4 rotationY = glm::rotate(mat4(1), t, vec3(0, 1, 0));
    mat4 rotationZ = glm::rotate(mat4(1), t, vec3(0, 0, 1));

    mat4 fullRotation = rotationX * rotationY * rotationZ;

    mat4 scale = mat4(1);

    model = translation * fullRotation * scale;
